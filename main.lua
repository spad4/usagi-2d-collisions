...
local polygon2 = Polygon.new({ corners = points, color = gfx.COLOR_RED, x = 128, y = 128 })
local polygon3 = Polygon.new({ corners = points, color = gfx.COLOR_RED, x = 192, y = 128 })

Polygons = { polygon, polygon2, polygon3 }


local function player_controls(dt)
